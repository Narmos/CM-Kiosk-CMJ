...
const storageData = chrome.storage.local.get();
...
var FxKeyboardLocale = '{'+
    ...
    '"main": [['+
            ...
            '["é", "!"],'+
            '["ê", "â"],'+
            '[{"label": "Retour", "special": 8, "flex": 10, "type": "repeat"}]'+ // backspace
        '], ['+
            '[{"label": "Tab", "string": "\\t", "flex": 15}],'+ // tab
            '["q", "Q"],'+
            '["w", "W"],'+
            '["e", "E"],'+
            '["r", "R"],'+
            ...
            '["û", "ü"],'+
            '["î", "ï"],'+
            '[{"label": "Entrée", "flex": 15, "special": 13}]'+ // enter
        "], ["+
            ...
            '["ô", "ö"],'+
            '["$", "€"],'+
            '[{"label": "#", "string":"#", "flex": 10, "special": 51}]'+
        '], ['+
...
FxKeyNumpad = JSON.stringify({
    ...
    "main": [
        [
            ...
            [{"label": "Retour", "special": 8, "flex": 1, "type": "repeat"}]
        ], [
            [{"label": "Fermer","special": "closeFX","flex": 1}]
        ]
    ]
...
var fxKeyboard = {
    ...
    _setSpecialFunctions: function(keyD,obj) {
        ...
        } else if (obj.label === "Accueil") {
            keyD.onmouseup = function () {
                keyD.style.backgroundColor = "rgb(255,255,255)";
                window.location = "https://collection.museejenisch.ch";
            };
...
chrome.runtime.onMessage.addListener(function begin(message) {
...
var textInputTypes = {
    'input': '', 'select': '', 'option': '', 'textarea': '', 'textbox': '',
    'text': '', 'password': '', 'url': '', 'color': '', 'date': '', 'datetime': '',
    'datetime-local': '', 'email': '', 'month': '', 'search': '', 'number': '',
    'range': '', 'tel': '', 'time': '', 'week': ''
    };
